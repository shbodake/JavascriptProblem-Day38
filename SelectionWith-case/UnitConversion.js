...
switch(num) {
    case 1:
        ...
        console.log(foot + "feet is equals to : " + feetToInch);
        break;
    case 2:
        let feet = prompt("Enter the feet ");
        let feetToMeter = (feet / 3.28084);
        console.log(feet + "feet is equals to : " + feetToMeter);
        break;
    case 3:
        let inch = prompt("Enter the inch ");
        let inchToFeet = (inch * 0.0833333);
        console.log(inch + "inch is equals to : " + inchToFeet);
        break;
    case 4:
        let meter = prompt("Enter the inch");
        let meterToFeet = (meter * 3.28084);
        console.log(meter + "meter is equals to : " + meterToFeet);
        break;
    case 0:
